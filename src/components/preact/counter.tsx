...
const Counter = () => {
  ...
  return (
    <div class="bg-neutral-200 dark:bg-neutral-800 p-4 rounded-[calc(theme(borderRadius.3xl)_-_1rem)] relative">
      <h2 class="mt-0 mb-4">{`${t("counter")}: ${value}`}</h2>
      <div class="flex justify-center items-center gap-2">
        <button
          class="bg-neutral-300 dark:bg-neutral-700 rounded-xl p-2 aspect-square overflow-hidden block leading-none w-8"
